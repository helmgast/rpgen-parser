function hamta_bakgrundstabeller() {
  ...
  bakgrundstabeller.jargiensbefolkning[1].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[1].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Mystikfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[2].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[2].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[3].beskrivning =
    "Om ingen ser efter städerna hamnar de snart i förfall. Hus rasar samman, kloakerna svämmar över, akvedukterna slammar igen. Arkitektorn har ansvaret för att se till att allt fungerar. Detta påverkar handeln samt var och när nya inrättningar får uppföras. Detta gör att positionen som arkitektor är en av de mest inkomstbringande när det gäller mutor då så gott som alla vill hålla sig väl med denne.";
  bakgrundstabeller.jargiensbefolkning[3].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[6].beskrivning =
    "När lagen hinner ifatt brottslingar är straffet ofta hårt. Händer ska kapas, tungor skäras ut och folk ska hängas från galgen, halshuggas eller bringas om livet på de sätt som makthavarna dömt. Detta är bestraffarens värv. Denne lever ständigt nära döden och är allt som oftast utstött och fruktad. Många har själva varit dödsdömda men blivit benådade i utbyte mot att bli bestraffare resten av livet.";
  bakgrundstabeller.jargiensbefolkning[6].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.jargiensbefolkning[7].beskrivning =
    "Med bläckstänkta händer och en stressad uppsyn så driver boktryckarna på med sin produktion av att trycka böcker åt kyrkan och privata aktörer. De graverar och gjuter hela sidor åt gången och deras hantverkarkonst ses på med misstanke och är mycket ogillade av skrivarna då deras roll blir allt mer försvagad ju fler böcker som trycks.";
  bakgrundstabeller.jargiensbefolkning[7].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.jargiensbefolkning[9].beskrivning =
    "Det finns lagar och regler för allt. Vad man får äta, var man får sova, vad man får handla med, vad man får säga, vad man får skriva, vad man får tänka. Brottslingen gör det till praxis att bryta mot de lagar som passar för att kunna tjäna sitt uppehälle. Det handlar ofta om smuggling, inbrott, rån och beskyddarverksamhet.";
  bakgrundstabeller.jargiensbefolkning[9].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[10].beskrivning =
    "I Kejsardömet finns många viljor som drar folket i olika riktningar och det är inte alltid alla dessa viljor tjänar de styrandes intressen. Många författare, skådespelare och filosofer har tankar och idéer som allvarligt skulle kunna skada den jargiska ordningen och därför finns det så kallade censorer som arbetar med att granska verk som skapas i Kejsardömet och se till att ingenting sprids som kan rubba maktbalansen.";
  bakgrundstabeller.jargiensbefolkning[10].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[11].beskrivning =
    "Det komplicerade jargiska systemet är en oöverskådlig spindelväv av lagar och paragrafer och det är consultatorns uppgift att dra i trådarna för att få byråkratin att agera på det sätt man önskar. Consultatorn agerar som advokat och rådgivare och alla större släkter har ett flertal consultatorer i sin tjänst. Ett fåtal av dessa använder systemet för att skapa rättvisa medan de flesta ser det som ett sätt att fylla sina egna kistor.";
  bakgrundstabeller.jargiensbefolkning[11].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Kunskapsfärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[12].beskrivning =
    "I skådespel om Kejsardömets storhetstid framför dansarna episka strider framför åskådarna. På smutsiga tavernor i talgljusens sotiga sken dansar skökor för druckna legionärer som kastar mynt vid deras fötter. I ädlingarnas palats framträder både kvinnor och män, med sina smidiga kroppar inoljade och pudrade med gyllene stoft. Alla rör de sig virvlande till rytmen av Kejsardömets taktfasta hjärtslag.";
  bakgrundstabeller.jargiensbefolkning[12].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[13].beskrivning =
    "Ord kan flytta berg, röra folkmassor till handling och få katastrofer att låta som glädjebud. En del demagoger är inte mer än skrävlare som uppmanar folk till handling, andra är anstiftare till blodiga uppror, karismatiska sektledare eller sådana som älskar att skapa konflikter. Några är talesmän för akademier eller inflytelserika familjer i Kejsardömet men många finner sig jagade och ansatta av makthavarna som ogillar deras lösa tungor.";
  bakgrundstabeller.jargiensbefolkning[13].beskrivninghak =
    "1 slag på valfri tabell, 4 enheter Sociala färdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.jargiensbefolkning[18].beskrivning =
    "På floder, sjöar och vid Igonhavets grunda stränder kan man se fiskarnas båtar. Vattnet är deras levebröd. Från djupet drar de upp sprattlande fiskar som glänser likt silver i solskenet. De lagar sina nät på ställningar vid stränderna och röker, saltar och jäser sin fångst. Många är vidskepliga och alla har de en respekt för vädrets makter, i synnerhet stormarna, som välter deras båtar och offrar dem till djupet.";
  bakgrundstabeller.jargiensbefolkning[18].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Vildmarksfärdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.jargiensbefolkning[19].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[22].beskrivning =
    "När det sker stridigheter dör de flesta långt efter slaget av sina skador. Fältskären försöker rädda livet på dessa. Denne läkekunnige är van att resa med legionerna eller håller sig nära borgar och gränsposteringar. Fältskärer är skickliga på att stoppa blödningar, spjälka ben och genomföra vissa enklare kirurgiska ingrepp men trots detta dukar många av patienterna under och få har sett så mycket lidande i livets sista timmar som dessa män och kvinnor.";
  bakgrundstabeller.jargiensbefolkning[22].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Kunskapsfärdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[23].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[23].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Kunskapsfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.jargiensbefolkning[25].beskrivning =
    "Skrikandes om erbjudanden om färsk fisk, vackra tyger, nybakt bröd och väldoftande oljor står gatuförsäljarna i sina små affärer för att locka in folkhopen för att köpa deras varor. Med snabba ord som likt honung söker sig in i kundernas öron så säljer de sina varor till folket. De använder alla knep som finns för att klara vardagen och samtidigt försöka hålla uppe sitt rykte till morgondagen.";
  bakgrundstabeller.jargiensbefolkning[25].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[26].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.jargiensbefolkning[29].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Kunskapsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[31].beskrivninghak =
    "1 slag på valfri tabell, 4 enheter Sociala färdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.jargiensbefolkning[33].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[33].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[34].beskrivning =
    "I städerna lever hantverkarna indelade i olika gillen. De mest inflytelserika hantverkarna är gillesmästare vilka anses vara några av stadens mäktigaste män som sitter på både rikligt med pengar och otaliga hantverkshemligheter. De som har lägst inflytande är lärlingar vilka under flera års tid får arbeta likt slavar åt någon av de andra medlemmarna i hopp om att lära sig värvet.";
  bakgrundstabeller.jargiensbefolkning[34].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.jargiensbefolkning[39].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[39].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Mystikfärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[40].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[40].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Vildmarksfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.jargiensbefolkning[41].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[41].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[42].beskrivning =
    "För köpmännen, ädlingarna, kyrkan, armén och givetvis Kejsaren har det alltid varit viktigt att veta hur geografin i riket och kolonierna ser ut. Kartograferna kan provinsernas gränser, vägar, vattendrag, floder, skogar, åkerareal samt även vilka länder som finns bortom haven, de nordliga bergen, slätterna och den förhatliga asköknen Tarkas. Många kartografer företar sig i sin ungdom dramatiska och farliga resor i Kejsardömets utkanter.";
  bakgrundstabeller.jargiensbefolkning[42].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Kunskapsfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.jargiensbefolkning[43].beskrivning =
    "Ägodelar, varor och pengar på villovägar ska naturligtvis beslagtas och återbördas till sin rättmätiga ägare. Oftast rör det sig om någon form av egendom som stulits, förskingrats eller överlåtits till en ny ägare. En konfiskatör eller apprendator stödjer sig på en konfiskationsorder som utfärdats av en magistrat och får normalt provision i efterhand – allt från en tiondel till hälften av godsets värde.";
  bakgrundstabeller.jargiensbefolkning[43].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Kunskapsfärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[44].beskrivning =
    "Konkubiner är mer än vanliga skökor då de tar hutlösa summor för sitt umgänge och blir således älskarinnor och älskare till de allra mest förmögna och inflytelserika. Konkubinerna måste alltid sträva efter att behålla gunsten och intresset då detta är deras levebröd och många är därför experter när det gäller förförelse eller utövandet av mer ovanliga sexuella akter. Andra har kommit att bli intuitiva och intelligenta rådgivare.";
  bakgrundstabeller.jargiensbefolkning[44].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.jargiensbefolkning[46].beskrivning =
    "I det väldiga Kejsardömet färdas nyheter långsamt. När bud måste skickas med hast eller nyheter måste spridas till rikets alla invånare sänds kurirryttare mellan städerna. De spikar upp plakat, levererar sigillförseglade brev och viskar kodade budskap till utvalda personer. Så gott som alla stora släkter har egna kurirryttare, likaså kyrkan och armén.";
  bakgrundstabeller.jargiensbefolkning[46].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Rörelsefärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[50].beskrivning =
    "Lantarbetarna är de lägsta bland jordbrukarna. Det är de som inte äger vare sig jord eller egendom men får slita mest av alla på fälten. Männen slår skörden i gassande solsken, kvinnorna samlar upp den i kärvar. Får vallas av unga pojkar och flickor och när hösten kommer grävs rovorna upp. Många drömmer om ett bättre liv där de äger jorden som de sliter på dag ut och dag in.";
  bakgrundstabeller.jargiensbefolkning[50].beskrivninghak =
    "1 slag på valfri tabell, 4 enheter Vildmarksfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.jargiensbefolkning[51].beskrivning =
    "De krigare som inte ansluter sig till legionerna blir ofta legosoldater. Vissa är före detta legionärer som valt att gå sin egen väg medan andra värvas direkt som unga män för att slåss i ett förband. Legosoldater reser land och rike runt för att slåss för dem som betalar bäst.";
  bakgrundstabeller.jargiensbefolkning[51].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[52].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[52].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[53].beskrivning =
    "Ständigt på flykt från inkvisitionens grepp är magikerna, begåvade mästare på att manipulera världen efter sin vilja. De bedriver sitt värv i hemlighet och många har ett annat yrke som fasad. Det finns dock hemliga magiska sällskap och många inflytelserika kan tänka sig att betala dyrt för att bruka den förbjudna magin så länge de inte blir sammankopplade med magikern ifråga.";
  bakgrundstabeller.jargiensbefolkning[53].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Mystikfärdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.jargiensbefolkning[55].beskrivning =
    "När folk blir sjuka, ben måste spjälkas och sår måste sys tillkallas en medikus. Denne specialiserar sig på kroppens mysterier och hur man botar åkommor genom åderlåtning, beska dekokter och stinkande salvor. Kunskapen om hur man når balans i kroppens vätskor gör dessa individer mycket respekterade.";
  bakgrundstabeller.jargiensbefolkning[55].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[56].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[56].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 valfria enheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[59].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[59].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[60].beskrivning =
    "Svurna till Daak och omgärdade av riter och mystik axlar ordensriddarna manteln som rikets beskyddare och Daaks förkämpar. De är respekterade och fruktade av folket då deras makt ofta gör dem onåbara för anklagelser vilket gör att vissa inte drar sig för att använda sitt inflytande för att ta det de vill utan rädsla för repressalier. Många är fanatiskt trogna den orden de tillhör och att försvara sin och dess ära tar upp all deras tid.";
  bakgrundstabeller.jargiensbefolkning[60].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[64].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[64].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Mystikfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[66].beskrivning =
    "Städerna svämmar över av råttor. De krälar i gränder, källare och kloaker. De tar sig in i de förnämsta husen och gnager sönder dyrbara mattor, äter det fattiga folkets förråd och stjäl mat direkt från värdshusens bord. Råttfångarna är trashankar som lever på att fånga in och ha ihjäl så många som möjligt av dessa gnagare för några kopparslantar i betalning. Vissa råttfångare passar på att tjäna några extra mynt genom att tillaga sin fångst och sälja dem i fattigkvarteren.";
  bakgrundstabeller.jargiensbefolkning[66].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Rörelsefärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[67].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[74].beskrivning =
    "Med skarpa intellekt, hängivenhet och uppmärksamhet tjänar de lärda slavarna sina mästare. De fungerar som lärare åt barn i familjen, rådgivare åt militärer eller räknar ut de mest gynnsamma handelskontrakten med tillhörande mutor. Dessa slavar har vanligen ett gott liv om än ej i frihet då de alla fruktar att på något sätt missbehaga sina herrar.";
  bakgrundstabeller.jargiensbefolkning[74].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Rörelsefärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[75].beskrivning =
    "De förmögna måste passas upp. Någon måste bada dem, torka deras kroppar, gnida in dem med väldoftande oljor, klä dem i finaste tyger, lägga fram besticken, sopa upp smutsen, polera silvret, rätta till gobelängerna, mata dem med druvor och sötsaker, springa med meddelanden, klippa deras naglar och vara i närheten för att hörsamma deras befallningar. Allt detta är tjänarnas uppgifter och har de tur kan de leva ett liv där de inte blir alltför pryglade och får äta sig mätta varje kväll.";
  bakgrundstabeller.jargiensbefolkning[75].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[79].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[79].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 4 valfria enheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[80].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[81].beskrivning =
    "Stadsportarna ska vaktas, handelsmännens varor ska sökas igenom, fyllebråk ska stoppas, det ska hållas utkik efter eldsvådor och brottslingar arresteras. Stadsvakten känner till varje gränd, varje bakgata, kommer ihåg ansiktena på de vanliga handelsmännen och har alltid ett öga på dem som tycks sticka ut. En del tar allvarligt på att hålla ordning i staden, andra ser det som en god position att ta mutor och är inte mycket mer än brottslingar med befogenheter.";
  bakgrundstabeller.jargiensbefolkning[81].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Sociala färdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[84].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[84].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[86].beskrivning =
    "Högt ovan hustaken och långt nere i stadens mörkaste vrår är det inte stadsvakten, prästerskapet, adeln eller köpmännen som regerar. Här lever tjuvarna på att ta från allt och alla som inte håller tillräckligt god uppsyn på sina fickor och hus.";
  bakgrundstabeller.jargiensbefolkning[86].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[87].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[87].beskrivninghak =
  ...
  bakgrundstabeller.jargiensbefolkning[88].beskrivning =
    "I Kejsardömets utkanter finns det gott om otillgängliga trakter. Djupa skogar, bergskedjor, träsk och gamla ruiner. I dessa områden kan man finna monstruösa bestar av olika slag. Troféjägaren har gjort en konst av att jaga och nedlägga monstren. Troféerna säljs sedan att pryda de vackra villorna i Kejsardömets övre skikt. Ibland fångas monstren in levande och säljs till gladiatorarenorna med god förtjänst.";
  bakgrundstabeller.jargiensbefolkning[88].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[90].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[90].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Kunskapsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[91].beskrivning =
    "När ett fyllebråk urartar och ett vänskapligt handgemäng övergår till sparkar och kanske dragna vapen behövs det någon som kan sära på de involverade och ge dem alla en kraftig spark mot dörren. Detta är utkastarens jobb. Om det inte vore för dessa individer skulle många krogar snart vara i spillror.";
  bakgrundstabeller.jargiensbefolkning[91].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.jargiensbefolkning[94].beskrivning =
    "Vapenmästarna ser strid som en konstform. De lär sig invecklade och många gånger vackra sätt att kämpa och för många handlar det mer om uppvisning än om faktiskt kamp. En del vapenmästare tjänar som instruktörer, livvakter eller underhållare i hoven. Andra vandrar mellan byarna och erbjuder sina tjänster för en handfull mynt.";
  bakgrundstabeller.jargiensbefolkning[94].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Rörelsefärdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[95].beskrivning =
    "Krig skördar sina offer och veteranen har dräpt fler än denne kan minnas och förlorat många vänner till vinande pilar och svärdshugg. Våldsamheterna har satt sina spår och många veteraner vrider sig i mardrömmar, häller i sig vin för att glömma eller har övergått till att bli obehagligt avtrubbade. Även om de krigiska dagarna är över för veteranen är det ack så lätt att ta till vapen för att tjäna några enkla silver då den vanliga världen för dem blivit främmande och olustig.";
  bakgrundstabeller.jargiensbefolkning[95].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[96].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.jargiensbefolkning[97].beskrivning =
  ...
  bakgrundstabeller.jargiensbefolkning[97].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Rörelsefärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.jargiensbefolkning[99].beskrivning =
    "De plågade skrik som kommer från Xinus anhängare är ett offer till den mörka guden. I sina privata tortyrkammare dyrkar de smärtans och det eviga lidandets prins, den mörka och vansinnige Xinu. Under svarta mässor når dyrkarna extas genom att piska sig och sina anhängare till ljudet av psalmerna. Få, om ens någon av de invigda kommer någonsin kunna återvända till den oskyldiga sinnesro som de en gång hade, sedan den sadistiska och förbjudna gudomen satt sina klor i deras själar. De anser sig utvalda inför den kommande striden och tränar för att bli Xinus förkämpar.";
  bakgrundstabeller.jargiensbefolkning[99].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Stridsfärdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.vildmark[2].beskrivning =
    "Även om det ofta faller på prästernas eller andebesvärjarnas lott, där sådana finns, kan den som behärskar konsten att berätta om forna tider vara en mycket aktad individ. Många har detta som ett rent sidointresse, men ett litet fåtal är så skickliga och uppskattade att deras råd och historieförtäljande gör stammen villig att stå för deras försörjning.";
  bakgrundstabeller.vildmark[2].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.vildmark[3].beskrivning =
    "Trots att de inte tillhör de renodlade krigarnas skara är många boskapsdrivare härdat folk som ofta rör sig en bit från stammens boplatser. De måste vara kapabla att skydda de värdefulla kreaturen undan vilddjur och boskapstjuvar, åtminstone tills hjälp kan anlända.";
  bakgrundstabeller.vildmark[3].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Stridsfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.vildmark[4].beskrivning =
    "I den ofta oförlåtande vildmark där de flesta stamfolk lever anses det vara vanvett att försöka klara sig helt ensam. Många enslingar är förskjutna från sina stammar för att de begått grova brott mot lag eller tabu, men det finns också alltid de som av egen vilja drar sig undan från gemenskapen. Få blir dock gamla med denna ensamma livsföring.";
  bakgrundstabeller.vildmark[4].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Vildmarksfärdigheter, 4 Valfria enheter.";
  ...
  bakgrundstabeller.vildmark[5].beskrivning =
  ...
  bakgrundstabeller.vildmark[5].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Kunskapsfärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.vildmark[7].beskrivning =
    "Vilka hantverk som utövas inom en stam beror på såväl de krav miljön ställer som folkets teknologiska nivå, men i alla händelser behövs det några som är skickliga på att skapa och reparera föremål. I många fall är det dessa ting som köpslagare sedan kan använda för att byta till sig främmande varor till stammen.";
  bakgrundstabeller.vildmark[7].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.vildmark[8].beskrivning =
    "Många som lever i stamsamhällen lär sig av nöden att lägga åtminstone klumpiga förband om de sår de allt för ofta drabbas av, men vid allvarligare skador söker man upp en helare. Det är inte alltid helaren är stammens mest respekterade person, men hen är viktig för folkets överlevnad.";
  bakgrundstabeller.vildmark[8].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.vildmark[9].beskrivning =
    "De flesta stamlevande folk ägnar sig i åtminstone någon mån åt jordbruk, eller åtminstone åt att veta var de mest närande växterna finns. I väldigt isolerade kulturer betraktas förmågan att veta när man ska så och hur man bäst skördar jordens frukter som närmast magisk och de som behärskar den som personer i god kontakt med naturens andar.";
  bakgrundstabeller.vildmark[9].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Vildmarksfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.vildmark[10].beskrivning =
    "Även om det inte betraktas som den mest ärorika sysslan i ofta krigiska kulturer är de som kan konsten att på bästa sätt bistå vid förlossningar mycket uppskattade. Deras hjälp kan ofta vara helt avgörande för moderns och barnets överlevnad, och många knyter starka band till de barn de hjälper till världen.";
  bakgrundstabeller.vildmark[10].beskrivninghak =
    "1 slag på valfri tabell, 4 enheter Kunskapsfärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.vildmark[11].beskrivning =
    "Jägare kan arbeta med mycket olika metoder beroende på var de lever, om de jagar i grupp, och i synnerhet på vad deras byte är. Detta är en mycket vanlig sysselsättning inom de flesta stamsamhällen.";
  bakgrundstabeller.vildmark[11].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Rörelsefärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.vildmark[13].beskrivning =
    "En ofri man eller kvinna är ofta slav eller träl, där sådana förekommer, men kan även ha tagits som krigsfånge. Ett fåtal har också förlorat sin frihet som straff för någon förbrytelse, även om det sällan är en vanlig form av bestraffning. Ofta har de ofria hårda arbetsuppgifter som inte tar dem för långt från folkets vakande ögon.";
  bakgrundstabeller.vildmark[13].beskrivninghak =
    "1 slag på valfri tabell, 4 enheter Vildmarksfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.vildmark[15].beskrivning =
  ...
  bakgrundstabeller.vildmark[15].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Mystikfärdigheter.";
  ...
  bakgrundstabeller.vildmark[16].beskrivning =
    "Som samlare räknas de som är vana att hitta såväl matnyttiga växter som örter som kan användas för färgningsarbeten och olika dekokter. I vissa fall har de roller som överlappar helarens, men många behärskar också konsten att brygga dödliga gifter.";
  bakgrundstabeller.vildmark[16].beskrivninghak =
    "1 slag på Färder & äventyr, 2 enheter Kunskapsfärdigheter, 2 enheter Vildmarksfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.vildmark[18].beskrivning =
  ...
  bakgrundstabeller.vildmark[18].beskrivninghak =
    "1 slag på Färder & äventyr, 4 Valfria enheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.vildmark[19].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.vildmark[20].beskrivning =
    "Stigfinnarnas värv överlappar ofta med jägarnas, men stigfinnarna är mer inriktade på att upptäcka ständigt nya resurser och smidigare färdesvägar på det område som stammen håller som sitt. De är ofta något av excentriska ensamvargar och kan emellanåt vara ifrån bosättningen längre tider, utan att på något sätt överge den.";
  bakgrundstabeller.vildmark[20].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Vildmarksfärdigheter, 2 poäng Kännetecken.";
  ...
  bakgrundstabeller.vildmark[22].beskrivning =
    "Många stamfolk har kommit att hålla sig med någon form av tränade djur, som exempelvis hundar eller olika riddjur. Att lära upp dessa är sällan en persons enda syssla, men det kan vara en krävande konst som kräver tålamod, slughet och en stark vilja.";
  bakgrundstabeller.vildmark[22].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Sociala färdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.vildmark[24].beskrivning =
    "Denna sorts specialiserade krigare förekommer inte i alla kulturer, men där de finns är de stolta över sitt värv och hyllade för det. Deras roll är att beskydda platser och, framför allt, individer av särskild vikt, vilket skiljer dem från de typiska kämparna som ofta har bredare sysselsättningar. Kloka ledare omger sig gärna med en eller flera dugliga väktare, liksom mystiker och sändebud av olika slag.";
  bakgrundstabeller.vildmark[24].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Sociala färdigheter 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[1].beskrivning =
    "Konsten att planera såväl hus som broar och andra byggen är såväl viktig som uppskattad, och dess utövare är ofta välbetalda. På detta område anses nermadierna tillhöra Mundanas allra främsta.";
  ...
  bakgrundstabeller.nermadasbefolkning[2].beskrivning =
    "Den som kan underhålla med musik och medryckande berättelser blir väl mottagen vart han än vandrar.";
  ...
  bakgrundstabeller.nermadasbefolkning[3].beskrivning =
    "Baroner och baronessor är inflytelserika länsherrar som styr ett län i utbyte mot en trohetsed till en av de sju grevarna och glatt intrigerar sinsemellan för att öka sin makt.";
  ...
  bakgrundstabeller.nermadasbefolkning[4].beskrivning =
    "Även i ett samhälle som det nermadiska, där bödeln inte befinner sig på botten av samhället, rör det sig om en fruktad och mytomspunnen person.";
  ...
  bakgrundstabeller.nermadasbefolkning[5].beskrivning =
    "Såväl i städerna som på landsbygden finns det folk som använder sig av allehanda ohederliga och inte sällan våldsamma metoder för att försöka bli rika eller bara överleva till nästa dag.";
  ...
  bakgrundstabeller.nermadasbefolkning[6].beskrivning =
    "Uråldriga traditioner från det coloniska imperiet förvaltas av de skickligaste underhållare, som framför fantastiska berättelser med sina akrobatiska danser.";
  ...
  bakgrundstabeller.nermadasbefolkning[7].beskrivning =
    "Vare sig de tjänar vid furstehov inom landet eller som Nermadas ambassadörer i fjärran länder är diplomaterna aktade för sina insatser och fruktade för sina lena tungor och slipade intellekt. ";
  ...
  bakgrundstabeller.nermadasbefolkning[8].beskrivning =
    "Döden tar alla, och alla måste tas om hand när livet är slut. Att gräva gravar och hantera de döda anses ofta vara en av samhällets lägsta sysslor, men deras täta kontakter med prästerskapet gör många dödgrävare förvånansvärt kunniga på allehanda områden.";
  ...
  bakgrundstabeller.nermadasbefolkning[9].beskrivning =
    "Havet skänker nermadierna en stor del av deras föda, och det anses vara ett rejält och hederligt arbete att med envishet och skicklighet skörda dess frukter.";
  ...
  bakgrundstabeller.nermadasbefolkning[10].beskrivning =
    "De lärda fyller mångahanda roller i samhället, och deras kunskaper kan vara av de mest skiftande slag. För många är en tjänst där man undervisar och rådger vid hoven den mest önskade sysslan, men lärda arbetar också inom handelsbolag eller på lägre poster inom administrationen.";
  ...
  bakgrundstabeller.nermadasbefolkning[11].beskrivning =
    "De djärvaste av läkekunniga söker sig till tjänster nära de strider där folk sargas av fienders vapen och bestars klor. Andra har helt enkelt oturen att kommenderas till tjänst på dessa utsatta platser, och gör vad de kan för att överleva och hålla andra vid liv.";
  bakgrundstabeller.nermadasbefolkning[11].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Kunskapsfärdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[12].beskrivning =
    "Varje sigill och vapensköld som skapas och varje dokument som undertecknas är en möjlighet för förfalskaren och hans ibland högt uppsatta uppdragsgivare.";
  bakgrundstabeller.nermadasbefolkning[12].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Kunskapsfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.nermadasbefolkning[13].beskrivning =
    "Varje ädling av betydelse måste ha skickliga stridsmän till hands som kan skydda såväl ägor som person. Dessa gardessoldater handplockas ofta bland de skickligaste krigare, och kan ha mycket olika träning och specialkompetens.";
  bakgrundstabeller.nermadasbefolkning[13].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 4 valfria enheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[14].beskrivning =
    "Mer framståendeköpmän markerar ofta sitt avstånd mot de månglare som måste skrika ut sina varors förträfflighet på gator och torg, men handlarna ser och hör mycket som inte når in i de slutna salongerna.";
  bakgrundstabeller.nermadasbefolkning[14].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.nermadasbefolkning[15].beskrivning =
    "Det finns alltid hårda arbeten som behöver göras, och många fattiga som sliter ut sina kroppar för att utföra dem.";
  bakgrundstabeller.nermadasbefolkning[15].beskrivninghak =
    "1 slag på valfri tabell, 4 enheter Vildmarksfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.nermadasbefolkning[16].beskrivning =
    "Gyckelkonster och deras utövare är långt ifrån lika aktade som att fängsla en publik med musik och sagor, men många har inget val och andra anser att ett liv i någon sorts frihet är värt rotlösheten och de sneda blickarna.";
  bakgrundstabeller.nermadasbefolkning[16].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Rörelsefärdigheter, 2 poäng Kännetecken.";
  ...
  bakgrundstabeller.nermadasbefolkning[17].beskrivning =
    "Om än betraktade som råskinn som man gör bäst i att inte stöta sig med fyller hamnsjåarna en mycket viktig funktion genom att lassa och lossa varor i Nermadas hamnar.";
  bakgrundstabeller.nermadasbefolkning[17].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.nermadasbefolkning[18].beskrivning =
    "Det finns alltid saker som behöver lagas eller skapas från grunden, och hantverkare låter sig svårligen klumpas ihop till en grupp. Allt från krukmakare till snickare och vapensmeder ryms i denna bakgrund.";
  bakgrundstabeller.nermadasbefolkning[18].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.nermadasbefolkning[19].beskrivning =
    "Det faller på häroldens lott att både skapa passande vapensköldar och med tillbörlig inlevelse tillkännage sin herres närvaro, så dessa ibland adliga män och kvinnor måste ha såväl hantverksmässig skicklighet som förmåga att ta folk.";
  bakgrundstabeller.nermadasbefolkning[19].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.nermadasbefolkning[20].beskrivning =
    "De flesta indrivare är föga mer än utpressare som jobbar för ännu värre skurkar, men vissa av dem tjänar någorlunda legitima herrar. Metoderna är dock ofta desamma.";
  bakgrundstabeller.nermadasbefolkning[20].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Sociala färdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[21].beskrivning =
    "Vare sig de driver boskap eller tvingar ur jorden dess ibland magra skördar är det jordbrukarna som tillsammans med fiskare och jägare står för att driva upp den mat som alla behöver.";
  bakgrundstabeller.nermadasbefolkning[21].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Vildmarksfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.nermadasbefolkning[22].beskrivning =
    "Att jaga för födan är inte särskilt vanligt i Nermada, och det är inte ovanligt att en stor del av den professionella jägarens tid går åt till att hålla ett vakande öga på länsherrens marker.";
  bakgrundstabeller.nermadasbefolkning[22].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[23].beskrivning =
    "Nermadas konstnärer är oftast skulptörer, men måleriet håller på att bli allt populärare och dess kvalitet allt högre. Konstnärerna distanserar sig gärna från de hantverkare med vilka de delar många drag, och är inte sällan av ädel börd.";
  bakgrundstabeller.nermadasbefolkning[23].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.nermadasbefolkning[24].beskrivning =
    "Kunskap är makt, och det finns alltid någon som är beredd att betala för hemligheter.";
  bakgrundstabeller.nermadasbefolkning[24].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[25].beskrivning =
    "Att färdas med bud ställer stora krav på såväl kuriren som hans riddjur. Det finns budbärare som arbetar för vem som än kan betala, men i allmänhet är de anställda av någon ädling eller förmögen person.";
  bakgrundstabeller.nermadasbefolkning[25].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Rörelsefärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[26].beskrivning =
    "Även om konkurrensen bland köpmännen är hård anser många att det är värt att ge sig in i den eviga kampen om den bästa affären. De främsta blir också närmast ofattbart rika.";
  bakgrundstabeller.nermadasbefolkning[26].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Kunskapsfärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[27].beskrivning =
    "De som strider för den som kan betala betraktas ofta som ett orosmoment i de styrandes ögon, men samtidigt behövs deras tjänster och de kan ibland dra in en god sold.";
  bakgrundstabeller.nermadasbefolkning[27].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[28].beskrivning =
    "Vare sig hon är en medikus i en stad eller en klok gumma på landsbygden är den läkekunniga mycket uppskattad, även om det alltid finns de som viskar bakom hennes rygg om källan till hennes kunskap.";
  bakgrundstabeller.nermadasbefolkning[28].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[29].beskrivning =
    "Innanför klostrens skyddande väggar kan de varmt troende reflektera över trons mysterier och dessutom förkovra sig i allehanda lärdom och färdigheter, allt efter sin ordens krav och sina egna talanger.";
  bakgrundstabeller.nermadasbefolkning[29].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 valfria enheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[30].beskrivning =
    "Att livnära sig på att låna ut pengar anses långt ifrån hedervärt, men den skicklige ockraren kan bli förmögen och leva i ett överflöd som annars är förbehållet adeln.";
  bakgrundstabeller.nermadasbefolkning[30].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 4 valfria enheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[31].beskrivning =
    "Besluten om var trupper ska placeras på slagfält och hur övergripande strategier ska läggas upp fattas av befäl som antingen själva är av nobel börd eller tjänar någon ädling. Dessa krigskonstens främsta leder dessutom djärvt trupper i strid.";
  bakgrundstabeller.nermadasbefolkning[31].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Kunskapsfärdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[32].beskrivning =
    "Havets fasor härjar även kring det fredliga Nermada, med såväl brutala överfall till havs som snabba strandhugg.";
  bakgrundstabeller.nermadasbefolkning[32].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[33].beskrivning =
    "Uppdragen att jaga ner personer på flykt kommer omväxlande från den dömande makten och från rika och hämndlystna privatpersoner. Vilka uppdrag prisjägaren tas styrs av dennes moral och möjlighet att välja och vraka, såtillvida han inte är anställd av någon vars order han bara har att lyda.";
  bakgrundstabeller.nermadasbefolkning[33].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Rörelsefärdigheter 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[34].beskrivning =
    "Vare sig man förmedlar Aurias och Pelias budskap eller tolkar Daaks heliga ord är prästen en mycket viktig och i allmänhet respekterad person.";
  bakgrundstabeller.nermadasbefolkning[34].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Kunskapsfärdigheter, 4 enheter Mystikfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[35].beskrivning =
    "Att tjäna sin länsherre med vapen i hand är ett sätt att leva och en källa till stolthet för Nermadas riddare.";
  bakgrundstabeller.nermadasbefolkning[35].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Sociala färdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[36].beskrivning =
    "Ingen kan berätta lika mycket om främmande länder och märkliga folk som en berest sjöman, men få stretar heller lika hårt eller riskerar lika mycket.";
  bakgrundstabeller.nermadasbefolkning[36].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Rörelsefärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[37].beskrivning =
    "Även om de flesta nermadier kan läsa och skriva åtminstone hjälpligt finns det goda möjligheter till arbeten för den som snabbt och elegant kan fästa ord på pränt.";
  bakgrundstabeller.nermadasbefolkning[37].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Kunskapsfärdigheter, 2 poäng Hantverk.";
  ...
  bakgrundstabeller.nermadasbefolkning[38].beskrivning =
    "Vare sig hon är mer eller mindre slav på någon bordell eller bespottad sockenhora ute på landet är skökan en kvinna som folk från alla samhällsskikt såväl föraktar som gör affärer med.";
  bakgrundstabeller.nermadasbefolkning[38].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.nermadasbefolkning[39].beskrivning =
    "Även om slaveriets omfattning har minskat används slavar alltjämt för en hel del ofta hårda och farliga arbeten.";
  bakgrundstabeller.nermadasbefolkning[39].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Rörelsefärdigheter, 4 valfria enheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[40].beskrivning =
    "De kämpar som strider på gladiatorarenorna är aldrig fria, men de kan vinna en berömmelse som arbetsslavar aldrig kommer i närheten av.";
  bakgrundstabeller.nermadasbefolkning[40].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 2 poäng Kännetecken.";
  ...
  bakgrundstabeller.nermadasbefolkning[41].beskrivning =
    "Slavhandlarna för en allt mer tynande tillvaro i en tid när de flesta slavar föds in i sina roller och ofta tjänar samma herre eller släkt under hela sina liv. Ännu går det dock att göra stora vinster i handeln med slavar som är dugliga eller på andra sätt intressanta.";
  bakgrundstabeller.nermadasbefolkning[41].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Sociala färdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.nermadasbefolkning[42].beskrivning =
    "Där det finns någon som kräver in tullar finns det någon som lever på att försöka frakta varor utan att behöva dela med sig av sina pengar.";
  bakgrundstabeller.nermadasbefolkning[42].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[43].beskrivning =
    "Som soldaten tillhör man de fasta militära styrkorna, och får en anständig stridsträning.";
  bakgrundstabeller.nermadasbefolkning[43].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Stridsfärdigheter, 4 valfria enheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[44].beskrivning =
    "Spelaren försörjer sig på att bedriva hasardspel eller vadslagningar, men få har den enorma talang eller sanslösa tur som krävs för att alltid kunna säkra en vinst på ärligt vis.";
  bakgrundstabeller.nermadasbefolkning[44].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[45].beskrivning =
    "Den dagliga tillvaron för stadsvakterna är sällan särskilt spännande, men städerna kan inte vara utan dem och det finns vissa möjligheter att avancera till bättre avlönade tjänster.";
  bakgrundstabeller.nermadasbefolkning[45].beskrivninghak =
    "1 slag på Strider & drabbningar, 4 enheter Sociala färdigheter, 4 enheter Stridsfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[46].beskrivning =
    "Grupper av desperata män och kvinnor slår sig ibland ihop och driver runt på landsbygden, där de stjäl vad de kan under hot om och utövande av våld. [1 slag på Färder & äventyr, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.]";
  bakgrundstabeller.nermadasbefolkning[46].beskrivninghak =
    "1 slag på Färder & äventyr, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[47].beskrivning =
    "Varje religion kan förr eller senare behöva försvaras med vapen i hand, och dessa strider är tempelriddarnas uppdrag.";
  bakgrundstabeller.nermadasbefolkning[47].beskrivninghak =
    "1 slag på Kunskap & mysterier, 4 enheter Stridsfärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[48].beskrivning =
    "Tjuvens tveksamma syssla kan bestå av allt från simpla fickstölder när ingen tittar till halsbrytande fasadklättring för att bryta sig in hos den som tror sig vara säker bakom höga murar.";
  bakgrundstabeller.nermadasbefolkning[48].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Rörelsefärdigheter, 4 enheter Vildmarksfärdigheter.";
  ...
  bakgrundstabeller.nermadasbefolkning[49].beskrivning =
    "Det ställe som kan tillhandahålla ätlig mat, starka drycker och anständigt loppfria bäddar kan utgöra ett välkommet inslag i stadsbilden eller vara en bys själva centrum, och somliga värdshusvärdar lever mycket gott på sin verksamhet.";
  bakgrundstabeller.nermadasbefolkning[49].beskrivninghak =
    "1 slag på valfri tabell, 4 enheter Sociala färdigheter, 2 poäng Expertiser.";
  ...
  bakgrundstabeller.nermadasbefolkning[50].beskrivning =
    "Kanske finns det inget mer typiskt nermadiskt yrke än den nobla sysselsättningen att förhandla fram äktenskap.";
  bakgrundstabeller.nermadasbefolkning[50].beskrivninghak =
    "1 slag på Intriger & illgärningar, 4 enheter Kunskapsfärdigheter, 4 enheter Sociala färdigheter.";
  ...
  bakgrundstabeller.damarien[3].beskrivning =
    "I trånga butiker i städerna, stugor på landsbygden eller täckta vagnar som rör sig mellan byarna förrättar apotekarna sitt värv. De förser folket med extrakt, salvor och dekokter som sägs bota allt från magont, eksem och varande sår till håravfall, impotens och tandvärk. Vissa kan konsten att sätta stopp för oönskade graviditeter och andra säljer gifter utan att ställa några frågor.";
  ...
  bakgrundstabeller.damarien[6].beskrivning =
  ...
  bakgrundstabeller.damarien[9].beskrivning =
  ...
  bakgrundstabeller.damarien[10].beskrivning =
  ...
  bakgrundstabeller.damarien[12].beskrivning =
    "Över hela storfurstendömet finns professionella dansare som roar hög som låg med sina rytmiska kroppsrörelser. Där finns allt från de hovdansare som underhåller furstar med sin skönhet och grace till folkdansare som leder böndernas skördefester. Det finns även de som genom sin dans berättar om helgonens liv i kyrkans mysteriespel och de som dansar urgamla rituella danser för att ära de gamla gudarna och de hedniska makterna.";
  ...
  bakgrundstabeller.damarien[16].beskrivning =
    "Den sista tiden närmar sig. Tecknen blir allt fler och snart kommer den mörke Malgoarh och hans demoner att störta in i världen och alla som inte är svurna till Daak kommer slitas i stycken och torteras i all evighet. Domedagspredikanterna inser detta och försöker med hängivelse, förkunnanden och öppna predikningar varna folket. Domedagspredikanterna kan man se på torg, vandrande mellan städer och utanför kyrkorna.";
  ...
  bakgrundstabeller.damarien[17].beskrivning =
  ...
  bakgrundstabeller.damarien[18].beskrivning =
    "Från norra Damarien kommer de mystiska faleni (sing	falenu) vars namn kommer från det vallanboriska ordet för nattfjärilar. Enligt sägnen hämtar nattfjärilar de dödas själar under natten och för dem till dödsriket. En människa som är falenu är en sorts hednisk präst eller andemedium som har en nära koppling till döden, antingen genom att de dött och återupplivats eller för att de haft en kraftfull nära-döden-upplevelse. Då man tror att de sett den andra sidan betraktas de som de dödas språkrör till de levande. Faleni kommer ursprungligen från Vallanborien, men man kan finna enstaka över hela storfurstendömet.";
  ...
  bakgrundstabeller.damarien[22].beskrivning =
  ...
  bakgrundstabeller.damarien[23].beskrivning =
    "När det sker stridigheter dör de flesta långt efter slaget av sina skador. Fältskären försöker rädda livet på dem. Denne läkekunnige är van att resa med soldater eller håller sig nära borgar och gränsposteringar. Fältskärer är skickliga på att stoppa blödningar, spjälka ben och genomföra vissa enklare kirurgiska ingrepp men trots detta dukar många av patienterna under och få har sett så mycket lidande i livets sista timmar som dessa män och kvinnor.";
  ...
  bakgrundstabeller.damarien[24].beskrivning =
    "Skrikandes erbjudanden om färsk fisk, vackra tyger, nybakt bröd och väldoftande oljor står gatuförsäljarna i sina små affärer och lockar in folkhopen för att köpa deras varor. Med snabba ord som likt ljuv musik söker sig in i kundernas öron säljer de sina varor. De använder alla knep som finns för att klara vardagen och samtidigt försöka hålla uppe sitt rykte till morgondagen.";
  ...
  bakgrundstabeller.damarien[27].beskrivning =
  ...
  bakgrundstabeller.damarien[30].beskrivning =
  ...
  bakgrundstabeller.damarien[32].beskrivning =
    "I städerna lever hantverkarna indelade i olika gillen. De mest inflytelserika hantverkarna är gillesmästare vilka anses vara några av stadens mäktigaste män som sitter på både rikligt med pengar och otaliga hantverkshemligheter. De som har lägst inflytande är lärlingar vilka under flera års tid får arbeta likt slavar åt någon av de andra medlemmarna i hopp om att lära sig värvet.";
  ...
  bakgrundstabeller.damarien[34].beskrivning =
  ...
  bakgrundstabeller.damarien[37].beskrivning =
  ...
  bakgrundstabeller.damarien[39].beskrivning =
    "Jordesoldatens vittnen är ett religiöst samfund som följer profeten Jordesoldatens läror om tapperhet, ärlighet, syskonskap och hårt arbete. Eftersom ordens medlemmar förkastar Daakkyrkans strikta hierarki har den förklarats kättersk av den jargiska moderkyrkan och rörelsens medlemmar, som inte tillåts ljuga om sin tro, jagas aktivt av inkvisitionen. I Damarien har rörelsen funnit en fristad och blivit populär bland hantverkare, soldater och andra Daaktroende som ser kyrkan som dekadent och korrupt.";
  ...
  bakgrundstabeller.damarien[40].beskrivning =
    "I den damariska vildmarken lever dessa simpla människor på sin skicklighet med spjut, båge och fällor. Då och då reser de tillbaka till städerna eller byarna med hudar, kött eller hantverk i horn och ben. Vissa jägare arbetar ensamma men andra väljer att ansluta sig till jaktlag som tillsammans driver och fäller bytet.";
  ...
  bakgrundstabeller.damarien[43].beskrivning =
  ...
  bakgrundstabeller.damarien[45].beskrivning =
  ...
  bakgrundstabeller.damarien[47].beskrivning =
    "Från de största borgarna till den enklaste trälstuga sjunger och berättar damarierna sånger, sagor och poesi. En skicklig sagoberättare är ett måste för varje respektabel ståndsperson och en skicklig kvädare med gott minne och vacker röst kan ofta leva väl på att vandra mellan byar och herresäten. Men det är långt ifrån ett farofritt värv, en missnöjd publik eller en adelsman som tror att någon av sagorna driver med honom kan leda till allt från bombardering med rutten frukt till ett fall från slottsmurarna.";
  ...
  bakgrundstabeller.damarien[48].beskrivning =
    "Köpmannen säljer, byter och köper varor och försöker pressa fram så stor vinst som det bara är möjligt. Djärva chanstagningar, försenade leveranser eller mördande konkurrens kan helt slå ut en köpman. Damariens hamnar är en lockande men farlig marknad för många köpmän, ty där kan storfurstens plötsliga infall eller plundrande pirater när som helst förvandla lycka till undergång.";
  ...
  bakgrundstabeller.damarien[49].beskrivning =
    "Damarien är ett rike som allt sedan sin födelse legat under de vandödas skugga och otaliga är sagorna om de bleka vampyrer som sägs stryka runt nattetid och tömma människor på blod. De är väsen som förkastat Daak men genom mörk magi vunnit skönhet, ofantlig styrka och evigt liv. Runt om i storfurstendömet existerar alltjämt kulter som dyrkar dessa varelser i svarta mässor och blodsriter i hopp om att få del av deras makt och kanske slutligen vinna odödlighetens gåva.";
  ...
  bakgrundstabeller.damarien[50].beskrivning =
    "De krigare som inte ansluter sig till storfurstens armé blir ofta legosoldater. Vissa är före detta soldater som valt att gå sin egen väg medan andra värvas direkt som unga män för att slåss i ett förband. Legosoldater reser land och rike runt för att slåss för dem som betalar bäst.";
  ...
  bakgrundstabeller.damarien[54].beskrivning =
    "Lurendrejaren tjänar sitt dagliga bröd genom att bedra sina medmänniskor och har med tiden utvecklat taskspel och bluffmakeri till en konstform oavsett om det rör sig om en charmör som sol-och-vårar ensamma ädlingar deras pengar eller en hänsynslös kvacksalvare som lurar av desperata sjuklingar deras sista slantar i utbyte mot verkningslösa kurer. Denna karriär kräver ett slipat munläder och en förmåga att snabbt försvinna och ligga lågt tills nästa möjlighet öppnar sig om någon börjar ställa obekväma frågor.";
  ...
  bakgrundstabeller.damarien[59].beskrivning =
    'Vad som började som Thamas personliga livvakt utvecklades snart till storfurstens obarmhärtiga, hatade och fruktade elitstyrka, obändigt lojala till storfursten och drottningen och som med en blandning av våld, skräck och stenhård disciplin säkrat kronan på Thamas huvud. Nattgardisterna har alla personligen valts ut av storfursten, fått riddarslaget av honom och har i folkmun kommit att få öknamnet "Mörkerhundarna". Orden är känd för sin förkärlek för att slå till mot storfurstens fiender om natten och medlemskap i sällskapet är en utmärkt väg till makt och inflytande vid hovet i Targus.';
  ...
  bakgrundstabeller.damarien[60].beskrivning =
  ...
  bakgrundstabeller.damarien[63].beskrivning =
  ...
  bakgrundstabeller.damarien[64].beskrivning =
    "Det finns många värdefulla saker som behöver skyddas; personer, egendomar och föremål. En protektor har till uppgift att mot betalning vaka över dessa och ta till vapen om så skulle krävas. En del agerar som livvakter till bortskämda ädlingar, andra bär och skyddar familjens sigillstämplar och vissa är anställda av handelshus för att se till att lasten kommer fram orörd.";
  ...
  bakgrundstabeller.damarien[65].beskrivning =
    "Storfurstendömet är en obarmhärtig plats och den som inte kan hålla sig på fötter trampas ned. Gamla personer dör ensamma i sina stugor, sjuka dukar under i feberfrossor och spädbarn skriker av hunger. Det finns dock de som svurit sina liv åt att bistå sjuka, lytta och modfällda även om de inte kan betala för sig. Dessa barmhärtiga människor finner man bland alla samhällsklasser, till och med på de mest oväntade ställen.";
  ...
  bakgrundstabeller.damarien[69].beskrivning =
    "I djupet av de mörka damariska skogarna vandrar skogvaktarna, män och kvinnor som arbetar för adeln och storfursten med att stoppa tjuvjägare och vedtjuvar. Skogvaktarens yrke kan vara ytterst riskabelt, då våldsamma konfrontationer med stråtrövare, fredlösa, monster och alver är en del av vardagen. Många skogvaktare är härdade krigare med stor vildmarksvana och respekt för de fasor och hemligheter som gömmer sig i skogarnas djup.";
  ...
  bakgrundstabeller.damarien[70].beskrivning =
    "Med bläckstänk på sina fingrar, en fjäderpenna i sitt grepp och böjd rygg fyller de ark efter ark med text. Skrivare finns överallt i storfurstendömet. Många arbetar som tjänstemän i byråkratin, andra skapar vackra kopior av kända böcker eller skriver ned order från militärer, handelsfurstar eller adelsmän. Då de skriver av och kopierar många texter och böcker besitter de ofta en bred kunskap om många olika ämnen och vissa har en insikt i affärer som inte bör bli allmänt kända.";
  ...
  bakgrundstabeller.damarien[71].beskrivning =
  ...
  bakgrundstabeller.damarien[72].beskrivning =
  ...
  bakgrundstabeller.damarien[73].beskrivning =
    "Att frakta varor genom Damarien eller till andra länder utan rätt papper är en omöjlighet och även om man har dessa försvinner mycket av vinsten i tull, mutor och skatter. Smugglaren ser till att frakta varor utan att någon får reda på det. En del leder mindre karavaner genom obygden, har dolda utrymmen i sina vagnar och de mest framgångsrika hela skepp fyllda med smuggelgods.";
  ...
  bakgrundstabeller.damarien[74].beskrivning =
    "Innan Thamas erövring av Damarien hade varje furstendöme och adelsfamilj sina egna styrkor, men efter att storfursten krossade de flesta av sina fiender har en gemensam armé, lojal endast till honom, börjat byggas upp. Tusentals unga damarier har tagits in till armén, ibland frivilligt och ibland med tvång, och tränas hårt på storfurstens slott i Targus och Hammarnäset. En soldats liv är ofta hårt och inramat, men många känner en starkt samhörighet och lojalitet mot härskaren som de i slutändan känner har givit dem och deras familjer ett bättre och tryggare liv.";
  ...
  bakgrundstabeller.damarien[75].beskrivning =
  ...
  bakgrundstabeller.damarien[77].beskrivning =
    "Stadsportarna ska vaktas, handelsmännens varor ska sökas igenom, fyllebråk ska stoppas, det ska hållas utkik efter eldsvådor och brottslingar arresteras. Stadsvakten känner till varje gränd, varje bakgata, kommer ihåg ansiktena på de vanliga handelsmännen och har alltid ett öga på dem som tycks sticka ut. En del tar allvarligt på att hålla ordning i staden, andra ser det som en god position att ta mutor och är inte mycket mer än brottslingar med befogenheter.";
  ...
  bakgrundstabeller.damarien[79].beskrivning =
  ...
  bakgrundstabeller.damarien[81].beskrivning =
  ...
  bakgrundstabeller.damarien[82].beskrivning =
    "Högt ovan hustaken och långt ner i stadens mörkaste vrår är det inte stadsvakten, prästerskapet, adeln eller köpmännen som regerar. Här lever tjuvarna på att ta från allt och alla som inte håller tillräckligt god uppsyn över sina fickor och hus.";
  ...
  bakgrundstabeller.damarien[84].beskrivning =
    "Damarien är fyllt av hemligheter som måste avslöjas och personer som måste straffas. Torterarens roll är att bryta sönder ett mänskligt psyke och tvinga fram erkännanden eller sarga offer till oigenkännlighet. I dunkla valv pressas glödgade tänger mot bar hud, lemmar slits ur led och piskor sargar kroppar. Torterare är vanligen anlitade av armén, stadsvakten, brottsorganisationer eller rika släkter. De som blir torterare är oftast kallhamrade individer eller personer som finner en stor njutning i sitt värv.";
  ...
  bakgrundstabeller.damarien[87].beskrivning =
    "När ett fyllebråk urartar och ett vänskapligt handgemäng övergår till sparkar och kanske dragna vapen behövs det någon som kan sära på de inblandade och ge dem alla en kraftig spark mot dörren. Detta är utkastarens jobb. Om det inte vore för dessa individer skulle många krogar snart vara i spillror.";
  ...
  bakgrundstabeller.damarien[88].beskrivning =
  ...
  bakgrundstabeller.damarien[91].beskrivning =
    "Vapenmästarna ser strid som en konstform. De lär sig invecklade och många gånger vackra sätt att kämpa och för många handlar det mer om uppvisning än om faktisk kamp. En del vapenmästare tjänar som instruktörer, livvakter eller underhållare hos de rika och mäktiga. Andra vandrar mellan byarna och erbjuder sina tjänster för en handfull mynt.";
  ...
  bakgrundstabeller.damarien[93].beskrivning =
    "Krig skördar sina offer och veteranen har dräpt fler än denne kan minnas och förlorat många vänner till vinande pilar och svärdshugg. Våldsamheterna har satt sina spår och många veteraner vrider sig i mardrömmar, häller i sig vin för att glömma eller har övergått till att bli obehagligt avtrubbade. Även om de krigiska dagarna är över för veteranen är det ack så lätt att ta till vapen för att tjäna några enkla silver då den vanliga världen för dem blivit främmande och olustig.";
  ...
  bakgrundstabeller.damarien[98].beskrivning =
    "De plågade skrik som kommer från Xinus anhängare är ett offer till den mörka guden. I sina privata tortyrkammare dyrkar de smärtans och det eviga lidandets furste, den vansinnige Xinu. Under svarta mässor når dyrkarna extas genom att piska sig och sina anhängare till ljudet av psalmerna. Få, om ens någon av de invigda kommer någonsin kunna återvända till den oskyldiga sinnesro som de en gång hade, sedan den sadistiska och förbjudna gudomen satt sina klor i deras själar. De anser sig utvalda inför den kommande striden och tränar för att bli Xinus förkämpar.";
  ...
  bakgrundstabeller.ghor[1].beskrivning =
    "I sina laboratorier och verkstäder arbetar de dvärgiska alkemisterna hårt för att nå nya kunskaper i materians mysterier eller för att skapa de elixir, preparat och magiska föremål som krävs för alla möjliga syften i dvärgarnas städer. ";
  ...
  bakgrundstabeller.ghor[2].beskrivning =
    "Dessa dvärgar har tilldelas hedersuppdraget att föra konungens och fästets talan i utombergingarnas riken. ";
  ...
  bakgrundstabeller.ghor[3].beskrivning =
    "I det urgamla och välordnade dvärgfästet kan arkiv och bibliotek nå enorma proportioner och för att byråkratin ska fungera kräver fästet därför hela truppstyrkor av noggranna, tålmodiga och pedantiska arkivarier. ";
  ...
  bakgrundstabeller.ghor[5].beskrivning =
    "Bryggarna framställer öl och andra jästa drycker, inklusive det legendariska kvasr-ölet, och betraktas därför av andra dvärgar som några av fästets mest respekterade hantverkare. ";
  ...
  bakgrundstabeller.ghor[6].beskrivning =
    "Med oändligt tålamod och stor yrkesstolthet förser svampodlarna i sina underjordiska odlingsgångar fästet med en stor del av den mat som de mångtaliga invånarna behöver. ";
  ...
  bakgrundstabeller.ghor[7].beskrivning =
    "De enorma, maskliknande varelser som kallas gruvbestar är en av de viktigaste källorna till kött och läder i dvärgfästet och föds upp i underjordiska farmer. Eftersom djuren kan vara mycket aggressiva måste skötarna vara vaksamma och bra på att försvara sig. ";
  ...
  bakgrundstabeller.ghor[8].beskrivning =
    "I mörkret under dvärgfästet sliter grävarna oavbrutet i sin jakt på resurser eller för att bygga ut dvärgarnas underjordiska domäner. ";
  ...
  bakgrundstabeller.ghor[9].beskrivning =
    "De dvärgiska köpmännen är bland de dvärgar som har allra mest kontakt med utombergingar, oavsett om de bedriver sitt arbete vid fästets portar eller om de köper och säljer sina varor i människornas städer och handelsstationer. ";
  ...
  bakgrundstabeller.ghor[10].beskrivning =
    "Otaliga hantverkare, från skräddare, snickare och garvare till guldsmeder, glasblåsare, bildhuggare och tatuerare sliter oavbrutet för att hålla liv i den väldiga dvärgastaden och dess aldrig sinande behov av alla möjliga varor och arbeten. ";
  ...
  bakgrundstabeller.ghor[11].beskrivning =
    "De dvärgiska ingenjörerna är några av Mundanas skickligaste och mest hemlighetsfulla forskare, byggare och uppfinnare. Det är tack vare dem dvärgarna kan titulera sig upphovsmän av allt från jättelika smältugnar till urverket, tryckpressen och siffran noll. ";
  ...
  bakgrundstabeller.ghor[12].beskrivning =
    "Kurirerna är modiga och uthålliga dvärgar som har tagit på sig det farliga arbetet att föra brev, befallningar och meddelanden mellan dvärgfästen och ibland även till utombergingarnas riken. ";
  ...
  bakgrundstabeller.ghor[13].beskrivning =
    "Kvädarna håller den dvärgiska historien, sagorna och sångerna levande genom att författa och framföra både nya och klassiska verk i samband med allt från högtidliga tillfällen till druckna värdshuskvällar. ";
  ...
  bakgrundstabeller.ghor[14].beskrivning =
    "Dessa dvärgar, oavsett om de arbetar som domare, anförare eller svarsförare, har vigt sina liv åt att studera de urgamla, hårda och mycket invecklade dvärgiska lagtexterna och att retoriskt skickligt argumentera för sin sak. ";
  ...
  bakgrundstabeller.ghor[15].beskrivning =
    "De dvärgiska läkarna har genom årtusenden kommit att producera några av Mundanas främsta helare, även om de är ytterst hemlighetsfulla och ovilliga att dela med sig av sina kunskaper till utombergingar. ";
  ...
  bakgrundstabeller.ghor[16].beskrivning =
    "Dvärgar i gemen misstror magi, även om de respekterar den stora kunskap och självdisciplin som utbildningen kräver och den makt som en skicklig magimästare besitter. Den dvärgiska magin är tätt knuten till Vontartron och nästan helt centrerad kring de fyra elementaraspekterna. ";
  ...
  bakgrundstabeller.ghor[17].beskrivning =
    "Alla dvärgar är värnpliktiga och har i uppdrag att skydda sitt fäste i krigstid. Några av milissoldaterna, bland annat portmilisen som skyddar fästets ytligaste kvarter, arbetar även i fredstid med att skydda dvärgastaden. ";
  ...
  bakgrundstabeller.ghor[18].beskrivning =
    "Det vanligaste straffet för brott i den dvärgiska kulturen är evig förvisning från fästet. De allra flesta dvärgar tar sitt liv efter en sådan dom och anses då ha försonats med Vontar, men ett fåtal nidingar väljer att fortsätta leva i skam och vanära utanför fästet. ";
  ...
  bakgrundstabeller.ghor[19].beskrivning =
    "Dvärgfästena hungrar alltid efter järn, guld, stenkol, rent vatten och andra naturresurser. Då är det prospektörernas värv att söka efter lämpliga nya stenbrott, gruvor, brunnar och ibland, i samarbete med utforskarna, även platser att uppföra nya fästen på. ";
  ...
  bakgrundstabeller.ghor[20].beskrivning =
    "I dvärgfästets monstruösa smedjor, omgivna av enorma masugnar, skapar några av Mundanas främsta smeder otroliga smidesarbeten i form av verktyg, vapen, maskindelar och konstruktionselement. ";
  ...
  bakgrundstabeller.ghor[21].beskrivning =
    "Spindelväktarna är vapenmästare vars uppgift går ut på att upptäcka och eliminera hot mot säkerheten i själva dvärgfästet, såsom tiraker, vättar, jättespindlar eller monster från djupen. De är så gott som oöverträffade vad gäller strider i underjordens mörker. ";
  ...
  bakgrundstabeller.ghor[22].beskrivning =
    "Bland utombergingar är tirakbanemännen de allra mest legendariska dvärgkrigarna. I krigstid är det deras uppgift att rekognosera och spana på fiender utanför dvärgfästet och i vissa fall leda överraskningsattacker och hämndaktioner mot utombergingarnas styrkor. ";
  ...
  bakgrundstabeller.ghor[23].beskrivning =
    "Några av de allra mest äventyrliga och modiga av dvärgarnas folk är de som under långa tider lämnar dvärgasamhällets trygghet och ger sig ut i världen för att finna nya riken, folkslag och platser lämpade för nya fästen och kolonier. ";
  ...
  bakgrundstabeller.ghor[24].beskrivning =
    "Vontars stränga prästerskap predikar gudens ord, och bidrar därtill med goda råd till varje dvärg som söker upp dem för att få vägledning vid svåra livsval. ";
  ...
  bakgrundstabeller.ghor[25].beskrivning =
    "Under dvärgkungen regeras varje fäste av äldstarnas råd, som dels består av de olika husens äldstar och dels av ämbetsäldstarna som utsetts av kungen. Äldstarna är ofta mycket kunniga och plikttrogna makthavare, men inte sällan extremt konservativa även med dvärgiska mått mätt. ";
  ...
  bakgrundstabeller.jarvskogen[1].beskrivning =
    "Järvskogens barder är poeter och musiker som underhåller sina trötta fränder vid dagens slut med lustiga sånger, sätter ord på de sörjandes smärta vid begravningar och komponerar verser som låter forna hjältars dåd leva för evigt.";
  ...
  bakgrundstabeller.jarvskogen[2].beskrivning =
    "De alviska byggmästarna i Järvskogen har under årtusenden inte bara lärt sig konsten att bygga avancerade, bekväma hem med mycket enkla medel, utan behärskar även konsten att uppföra hela byar så väl kamouflerade att de är i det närmaste omöjliga att finna för den oinvigde.";
  ...
  bakgrundstabeller.jarvskogen[3].beskrivning =
    "Järvskogsalverna har under lång tid tämjt och domesticerat otaliga djur. Särskilda djurskötare övervakar aveln, tämjandet och skötseln av dessa djur, oavsett om det rör sig om silkesmaskar, tama jätteskogskatter eller jaktfalkar.";
  ...
  bakgrundstabeller.jarvskogen[4].beskrivning =
    "En del alver är av olika skäl inte längre en del av den alviska gemenskapens skydd och värme, utan lever istället ensamma liv ute i vildmarken. Oavsett om så har skett grund av alvens eget val eller om denne förvisats för något brott har denne tvingats lära sig överleva på egen hand i en farlig värld.";
  ...
  bakgrundstabeller.jarvskogen[6].beskrivning =
    "Vart och ett av de tre järvskogshusen regeras av varsin husfurste, som formellt är underställd autokraten i Emori, även om de i praktiken är självstyrande. Under dessa tre står furstarna, som närmast motsvarar människornas baroner. Dessa titlar är ärftliga och många fursteätter kan spåra sitt ursprung åtskilliga årtusenden tillbaka i tiden.";
  ...
  bakgrundstabeller.jarvskogen[8].beskrivning =
    "Skräddare, garvare och pilmakare utgör ryggraden i thismalvernas samhälle och bland de egalitära järvskogsalverna är det snarare regel än undantag att en riktigt skicklig hantverksmästare belönas med en ädlingstitel.";
  ...
  bakgrundstabeller.jarvskogen[9].beskrivning =
    "Jägarnas arbete går dels ut på att förse sina fränder med viltkött, men även att spåra och jaga ned farliga monster och odjur som hotar alvsamhället.";
  ...
  bakgrundstabeller.jarvskogen[11].beskrivning =
    "De alviska helarna är väl bevandrade i många av läkekonstens och kirurgins mysterier. Med sina läkekonster och helande sånger har de under årens lopp slitit otaliga av sina fränder ur dödens armar.";
  ...
  bakgrundstabeller.jarvskogen[12].beskrivning =
    "Järvskogen är fattig på böcker, skriftrullar och högre bildning, vilket gör att de få lärda kvinnor och män som ändå lever i skogen kommit att bli mästare på memorering och muntliga traditioner. Många av dem undervisar unga alver och är rådgivare vid furstehoven.";
  ...
  bakgrundstabeller.jarvskogen[13].beskrivning =
    "Dessa alver har lyckats få en héave-drake präglad på sig och utgör därför en del av en vördad elitgrupp av luftburna spejare och krigare.";
  ...
  bakgrundstabeller.jarvskogen[14].beskrivning =
    "Utan tillgång till hjälp från sanaristammens hemlighetsfulla magimästare har ett fåtal av Järvskogens thismalver börjat utforska magins mysterier på egen hand.";
  ...
  bakgrundstabeller.jarvskogen[15].beskrivning =
    "Bland trädkronorna och i väl undangömda gläntor breder fält och odlingar ut sig i den mörka skogen och här arbetar alviska odlare hårt för att förse sina fränder med föda.";
  ...
  bakgrundstabeller.jarvskogen[16].beskrivning =
    "Dessa de allra mest legendariska och fruktade av alvkrigare är oöverträffade bågskyttar och mästare på att röra sig obemärkt genom vildmarken.";
  ...
  bakgrundstabeller.jarvskogen[17].beskrivning =
    "Endast en liten, men inflytelserik del av Järvskogens praktiskt lagda och föga lärdomsaktiga alver behärskar skrivkonsten och bokföringens ädla konst, men dessa har dock ofta en hög maktställning nära maktens centrum.";
  ...
  bakgrundstabeller.jarvskogen[18].beskrivning =
    "Oavsett om de arbetar med att tillverka grovsmide, verktyg eller vapen är smederna vitala för järvskogsalvernas överlevnad. Bristen på metall gör att endast skogens skickligaste hantverkarna tillåts utöva detta yrke.";
  ...
  bakgrundstabeller.jarvskogen[19].beskrivning =
    "Det sägs vara omöjligt att korsa Järvskogens bryn utan att känna ilningar från alviska blickar. Spanarna finns överallt i skogarna, där de dolda bland träden och undervegetationen håller inkräktare och andra hot under uppsikt.";
  ...
  bakgrundstabeller.jarvskogen[20].beskrivning =
    "När någon måste korsa den mörka vildmarken bortom alvernas bosättningar tar de ofta hjälp av de många skickliga och orädda stigfinnarna. Dessa guider och vildmarksvandrare lever på gränsen mellan alvernas riken och vildmarkens fasor och känner bättre än någon annan de snabbaste och säkraste vägarna genom skogarna.";
  ...
  bakgrundstabeller.jarvskogen[21].beskrivning =
    "När Järvskogens alver måste föra meddelanden till utomstående såsom andra alver, människor eller dvärgar, då skickar de sändebuden. Då de delvis är ambassadörer och delvis postiljoner måste de vara såväl snabba som stridsvana, politiskt pålästa och kvicka i repliken.";
  ...
  bakgrundstabeller.jarvskogen[22].beskrivning =
    "Järvskogens alver uppför många av sina byggnader i skogens alltjämt levande träd. Det är trädmästarna som genom en blandning av magiska och världsliga medel möjliggör detta genom att forma träden. De ansvarar även för att skydda dem mot röta och skadedjursangrepp.";
  ...
  bakgrundstabeller.jarvskogen[24].beskrivning =
  ...
  bakgrundstabeller.jarvskogen[25].beskrivning =
    "När det kommer till kunskaper om de remarkabla egenskaperna hos skogens många växter finns det ingen mer kunnig än de alviska örtmästarna, som förser samhället både med vildvippans läkande krafter, månklockans förrädiska gift och alvgräsets lugnande dunster.";
...
module.exports = hamta_bakgrundstabeller;
